...
class layout_Office_ch3 {
    ...
    var talks = TalkData_Ch3_part1()
    var profileOrder = ImgOrderData_Ch3_part1()
    // [주인공, 사자]
    ...
    var choices = ChoiceData_Ch3_part1()
    var response = Response_Ch3_part1()
