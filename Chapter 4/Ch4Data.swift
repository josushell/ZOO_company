...
class TalkData_Ch4_part1: TalkData {
    ...
    override init() {
        ...
        player = ["(아니 이분은 초엘리트 구구대 수석 졸업 박사 출신 박쥐 상사님이잖아?!)", "헉 안녕하십니까!", "넵! 감사합니다!", "넵! 지금 바로 보내드릴게요!", "아니 잠깐만 아까 졸면서 모르고 백스페이스를 계속 눌러버렸잖아?!", "파일이 다 사라져버렸어! 어떻게 하지?"]
...
class ImgOrderData_Ch4_part1: ImgOrderData {
    ...
    override init() {
        ...
        player = ["suit_surprise", "suit_surprise", "suit_laugh", "suit_laugh", "suit_surprise", "suit_sad"]
        bat = ["lion_normal"]
    }
}
...
class Response_Ch4_part1: Response {
    ...
    override init() {
        ...
        player_response = [["후... 일단 기억을 더듬어서 최대한 복구해보자!", "땃쥐님 정말 죄송하지만 착오가 생겨서... 다시 해야될 것 같습니다ㅠㅠ", "이걸 또 처음부터 하라고? 아 귀찮아\n그냥 썼던 부분을 요약해서 보내드리자"]]
...
class TalkData_Ch4_part2: TalkData {
    ...
    override init() {
        ...
        player = ["휴... 간신히 다 했다", "잠깐만 벌써 새벽 1시라고?", "으악!! 깜짝이야!!! 도대체 누구세요?!", "엇 비둘기 사장님?"]
