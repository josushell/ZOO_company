...
class TalkData_Ch5_part1: TalkData {
    ...
    override init() {
        ...
        player = ["오늘 출근해서 한번도 메일을 못봤네...\n지금이라도 봐야겠다.", "어라 땃쥐님께서 메일을 보내셨네?", "확인해볼까?", "벌써 30분 뒤면 시작이잖아?!", "좋아, 이 프로젝트를 성공시켜서 나의 실력을 보여주는거야.", "하지만 회사에서 처음 하는 프로젝트 발표라니... 너무 긴장되잖아!", "이럴 때는 뭘 하면 좋을까?", "아 네네! 알겠습니다!!", "좋아 연습한대로만 하는거야!"]
...
class Response_Ch5_part1: Response {
    override init() {
        ...
        player_response = [["역시 긴장 푸는 데에는 청심환이 최고지! \(name) 파이팅!", "일단 클래식을 들으면서 진정해보자... 휴 마음이 편안해진다~", "이미 연습을 94183번 정도 했지만 마지막으로 한번만 더 해야겠다\n저 빈 회의실 좀 쓸게요!"]]
...
class TalkData_Ch5_part2: TalkData {
    ...
    override init() {
        ...
        penguin = ["지금부터 저희 부서에서 준비한 프로젝트 초안 발표회 시작하도록 하겠습니다.", "먼저 프로젝트 개요에 대한 발표는 저희 부서 \(name) 사원이 진행하도록 하겠습니다."]
        player = ["안녕하십니까! 저는 이번 발표를 맡은 \(name) 사원입니다.", "지금부터 프로젝트 발표를 시작하도록 하겠습니다.", "....해서 이번 구구테크 프로젝트는 이렇게 진행 될 예정입니다.\n다음 그래프를 보시면....", "큰일났다! 사장님 화나신 것 같네.", "누구의 생각이라고 해야하지?!", "...이상으로 발표를 마치도록 하겠습니다. 감사합니다.", "발표에서 궁금한 점들을 질문해주시면 답변해드리도록 하겠습니다.", "이렇게나 내 발표에 궁금한 점이 많다고?!\n내가 제대로 한게 맞는건가?", "그건 그렇고 누구의 질문부터 받아야 할까?"]
...
class Response_Ch5_part2: Response {
    ...
    override init() {
        ...
        player_response = [["제 아이디어입니다... 혹시 무슨 문제라도...?", "알파카 대리님의 아이디어입니다... 혹시 무슨 문제라도...?", "저희 부서가 회의를 통해 생각해낸 아이디어입니다...\n혹시 무슨 문제라도...?", "감사합니다! (휴.. 혼나는 줄 알았네)", "이럴줄 알았으면 솔직하게 내가 했다고 말할걸 그랬네...", "감사합니다! (휴.. 혼나는 줄 알았네)"], ["그래, 역시 이런 건 순서대로 해야 제일 공정하지.", "다른 분들의 질문은 너무 무서워...\n일단 제일 대답하기 쉬운 원숭이 사원의 질문부터 받아야겠다.", "역시 이럴 때는 가장 높은 분의 질문부터 먼저 받아야겠지?", "뱁새 과장님 질문부터 받도록 하겠습니다!", "원숭이 사원님 질문부터 받도록 하겠습니다!", "비둘기 사장님의 질문부터 받도록 하겠습니다!"]]
