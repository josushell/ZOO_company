...
class Response_Ch1_part1: Response {
    override init() {
        ...
        player_response = [["일찍 일어난 새가 벌레를 잡는다고 하지!\n이왕 일찍 일어난 김에 1시간 먼저 나가서 청소도 하고 업무도 미리미리 해야지!", "일찍 일어나는 새는 일찍 피곤하다.. 조금만 더 자야지..", "첫 출근이니까 완벽하게 준비를 해야지~ 아침밥 먹고 힘내서 출근하자!"]]
...
class TalkData_Ch1_part2: TalkData {
    override init() {
        ...
        player = ["휴... 다행히 제 시간에 탔다!\n어디보자... 어느 역에서 내려야하지?", "이번 역은 주 컴퍼니역입니다. 내리실 문은 왼쪽입니다.", "아니 벌써 도착이잖아!", "내려야 하는데... 사람이 왜 이렇게 많아?!", "안돼, 첫 날부터 늦을 순 없어! 어떻게든 여기서 나가야만 해!!"]
    }
}
...
class Response_Ch1_part3: Response {
    override init() {
        ...
        player_response = [["후 간신히 내렸네.. 역시 출근길 9호선 급행은 지옥이야.", "헐 5분 밖에 안 남았잖아! 이럴 시간이 없어 빨리 가자!!"], ["결국 늦어버렸어.. 하지만 첫 날이니까 짤리지는 않겠지...? ㅠㅠ", "어쨌든 빨리 뛰어 가자!"]]
